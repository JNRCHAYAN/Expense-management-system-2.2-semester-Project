...
$test = array();
$count =0;
$query = "SELECT sum(amount) as total , MONTHNAME(expense_date) as mo FROM expenses WHERE user_id =$u GROUP BY MONTH(expense_date)";
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	theme: "light2",
	title:{
		text: "Monthly Expenses Review Bar Chart"
	},
	axisY: {
		title: "Amount"
	},
