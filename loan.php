...
if (isset($_POST['search'])) {
    ...
    $searchQuery = "AND BankName LIKE '%$searchValue%'";
}
?>
            ...
            <section>
                ...
                <div class="option_dev">
                    <div class="option_1">
                        ...
                        <p>Total Loan</p><br>
                        <a href="loan_Add.php">
                            <button class="btn" id="addRowButton">Add Loan</button>
                        </a>
                    </div>
                </div>
            </section>
            ...
            <section class="add_invest">
                ...
                <div class="in_form" id="formContainer">
                    <form action="" method="post">
                        <input type="text" id="bank_name" name="bank_name" placeholder="Search Your Bank Name" required>
                ...
                <table>
                    ...
                    <tbody>
                        <?php
                        $selectquery = "SELECT * FROM loans WHERE user_id = $u $searchQuery ORDER BY created_at DESC;";
                        $qery = mysqli_query($con, $selectquery);
                        $coutt = 0;
